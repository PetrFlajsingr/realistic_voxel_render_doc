...
\subsubsection{Renderování scény pomocí této metody}
...
\subsubsection{Nepřímé osvětlení}
...
Implementace \texttt{CheckBox} vyžaduje jen \~10 řádků kódu - nepočítaje deklarace funkcí a tělo konstruktoru - s~tím, že dědí z~\texttt{ItemElement}, \texttt{Labellable}, \texttt{Savable}, \texttt{ValueObservable<bool>}, \texttt{ColorCustomizable<...>} a \texttt{StyleCustomizable<...>}.
