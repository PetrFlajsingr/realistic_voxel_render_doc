...
Jak již bylo zmíněno, pro efektivní práci s velkým množstvím voxelů je potřeba využít akceleračních struktur pro práci s nimi. V této sekci najdete popis některých struktur, které se dají pro voxely použít.
